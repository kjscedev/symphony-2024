function syahi() {
  return (
    ...
    style={{backgroundImage: "url('bg.png')", backgroundRepeat: "no-repeat", backgroundSize: "cover"}}>
      ...
      <div className=" h-[50vh] w-[80vw] md:h-[70vh] md:w-[70vw] flex justify-center items-center m-auto backdrop-blur-xl rounded-3xl border-2 border-yellow-300">
        <div>
          <div className=" m-auto -mt-7 text-black text-center  font-bold text-6xl">
            Syahi
          </div>
          <div className=" mt-5 m-auto w-[60vw] text-black md:text-3xl text-[17px] ">
